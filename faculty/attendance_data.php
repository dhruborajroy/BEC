            ...
            <div class="col-12 row">
                ...
                <table class="table bs-table table-striped table-bordered">
                    <?php 
                        ...
                        $student_query = "SELECT s.id, s.name, s.class_roll, s.reg_no FROM students s ORDER BY s.class_roll ASC";
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td class="text-center"><?php echo isset($student['reg_no']) ? $student['reg_no'] : 'N/A'; ?></td>
                            <td class="text-center"><?php echo isset($student['name']) ? $student['name'] : 'N/A'; ?></td>
                            <?php foreach ($dates as $date) {
                                echo "<td class=\"text-center\">" . $student['attendance'][$date] . "</td>";
                            } ?>
                            <td class="text-center"><?php echo $attendance_percentage; ?></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
