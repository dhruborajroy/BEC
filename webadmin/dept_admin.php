...
if(isset($_GET['type']) && $_GET['type']!=='' && isset($_GET['id']) && $_GET['id']>0){
	...
	if($type=='delete'){
		mysqli_query($con,"delete from dept_admin where id='$id'");
		redirect('dept_admin');
	}
	if($type=='active' || $type=='deactive'){
		...
		mysqli_query($con,"update dept_admin set status='$status' where id='$id'");
        redirect('./dept_admin');
	}
            ...
            <div class="heading-layout1">
                ...
                <div class="dropdown show">
                    <div class="col-12 form-group mg-t-8">
                        <a href="manage_dept_admin"> <button type="submit"
                                class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Add new dept Admin</button>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <table class="table display data-table text-nowrap">
                    ...
                    <tbody id="myTable">
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td class="sorting_1 dtr-control"><?php echo $row['dept_id']?></td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="manage_dept_admin.php?id=<?php echo md5($row['id'])?>"><i
