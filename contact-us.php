...
?>
    <!--=================================inner-header -->
    <section class="inner-banner bg-overlay-black-70 bg-holder" style="background-image: url('../images/bg/01.jpg');">
      <div class="container">
    ...
    <section class="space-ptb">
      ...
      <div class="row col-lg-12">
          <div class="col-lg-12 mb-4 mb-lg-0 contect-center">
            <h3 align="center">
              বরিশাল ইঞ্জিনিয়ারিং কলেজ <br>
              উত্তর দূর্গাপুর, বরিশাল সদর, বরিশাল <br>
              ফোন:  <br>
              ইমেইল: becbarishal@gmail.com  
            </h3 >
          </div>
