...
<html class="no-js" lang="">
   ...
   <head>
      ...
      <!-- font awesome -->
      <!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.2/../webadmin/css/fontawesome.min.css" /> -->
      ...
      <link rel="stylesheet" href="../webadmin/css/invoice.css">
            ...
            <ul class="nav nav-sidebar-menu sidebar-toggle-view">
               ...
               <li class="nav-item sidebar-nav-item">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu ">
                                <li class="nav-item">
                                    <a href="departments" class=" nav-link "><i
                                            class="fas fa-angle-right"></i>All
                                        Departments</a>
                                </li>
                                <li class="nav-item">
