...
if(mysqli_num_rows($result)>=1){
    while ($student = mysqli_fetch_assoc($result)) {
        ...
        $mpdf->SetFooter('<div style="text-align:center;">Developed By <a href="index" > Dhrubo Raj Roy </a></div>');
...
// $all_mpdf->SetFooter('<div style="text-align:center;">Developed By <a href="index" > Dhrubo Raj Roy </a></div>');
